					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<?php if ($this->session->flashdata('image_error')) : ?>
								<small class="form-text badge text-bg-danger"><?= $this->session->flashdata('image_error') ?></small>
							<?php endif ?>
						</div>
					</div>
					<div class="card-footer">
						<button type="submit" class="btn text-bg-success">Konfirmasi Pembayaran</button>
					</div>
				</form>
			</div>
		</div>
